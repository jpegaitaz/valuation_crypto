...
def analyze_crypto(symbol):
    ...
    try:
        image_prompt = f"Create an impactful related image, pixar like style, of a cartoon character. The image has to be impactful and humoristic, with a blénd of cartoonish and pop art like influence. The theme of the image are the events or annoucements related to {crypto_id} found on https://www.coindesk.com/," 
